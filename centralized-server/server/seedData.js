...
const USER_GOVT_PROOF = {
  ...
  "WPHQ-002": {
    ...
    panNumber: "ABCNS7654B",
    bankAccount: "20123456789012",
    bankName: "SBI",
    ifscCode: "SBIN0056789",
  },
  "WPHQ-003": {
    aadhaarNumber: "456789012345",
    panNumber: "AKLKI8901C",
    bankAccount: "60123456789012",
    bankName: "ICICI Bank",
    ifscCode: "ICIC0007890",
  },
  "WPHQ-004": {
    aadhaarNumber: "567890123456",
    panNumber: "AMNMI2345D",
    bankAccount: "11234567890123",
    bankName: "Axis Bank",
    ifscCode: "AXIS0012345",
  },
  "WPLB-001": {
    aadhaarNumber: "678901234567",
    panNumber: "ABPRP6789E",
    passportNumber: "P7654321",
    bankAccount: "50234567890123",
    bankName: "HDFC Bank",
    ifscCode: "HDFC0056789",
  },
  "WPLB-002": {
    aadhaarNumber: "789012345678",
    panNumber: "ABCKA3456F",
    bankAccount: "20345678901234",
    bankName: "SBI",
    ifscCode: "SBIN0090123",
  },
  "WPLB-003": {
    aadhaarNumber: "890123456789",
    panNumber: "ABOSB7890G",
    bankAccount: "30456789012345",
    bankName: "Punjab National Bank",
    ifscCode: "PUNB0012345",
  },
  "WPLB-004": {
    aadhaarNumber: "901234567890",
    panNumber: "AERAR2345H",
    bankAccount: "40567890123456",
    bankName: "ICICI Bank",
    ifscCode: "ICIC0056789",
  },
  "WPCR-001": {
    aadhaarNumber: "012345678901",
    panNumber: "ABIPN5678I",
    passportNumber: "P9876543",
    bankAccount: "50678901234567",
    bankName: "HDFC Bank",
    ifscCode: "HDFC0090123",
  },
  "WPCR-002": {
    aadhaarNumber: "123456789012",
    panNumber: "ABMDM9012J",
    bankAccount: "60789012345678",
    bankName: "Axis Bank",
    ifscCode: "AXIS0056789",
  },
  "WPCR-003": {
    aadhaarNumber: "234567890124",
    panNumber: "ABADA3456K",
    bankAccount: "20890123456789",
    bankName: "SBI",
    ifscCode: "SBIN0123456",
  },
  "WPCR-004": {
    aadhaarNumber: "345678901235",
    panNumber: "ABVKV7890L",
    bankAccount: "30901234567890",
    bankName: "Punjab National Bank",
...
const USER_SOCIAL_LINKS = {
  "WPHQ-001": {
    ...
    twitter: "https://twitter.com/aarav_mehta",
  },
  "WPHQ-002": {
    linkedin: "https://linkedin.com/in/neha-sharma-dev",
    github: "https://github.com/nehasharma",
    portfolio: "https://nehasharma.dev",
  },
  "WPHQ-003": {
    linkedin: "https://linkedin.com/in/imran-khan-eng",
    github: "https://github.com/imrankhan",
    portfolio: "https://imrankhan.io",
  },
  "WPHQ-004": { linkedin: "https://linkedin.com/in/meera-iyer-data", github: "https://github.com/meeraiyer" },
  "WPLB-001": {
    linkedin: "https://linkedin.com/in/riya-patel-pm",
    twitter: "https://twitter.com/riya_patel",
    portfolio: "https://riyapatel.in",
  },
  "WPLB-002": {
    linkedin: "https://linkedin.com/in/kabir-anand-ml",
    github: "https://github.com/kabiranand",
    portfolio: "https://kabiranand.ai",
  },
  "WPLB-003": { linkedin: "https://linkedin.com/in/sanya-bose-nlp", github: "https://github.com/sanyabose" },
  "WPLB-004": {
    linkedin: "https://linkedin.com/in/arjun-roy-devops",
    github: "https://github.com/arjunroy",
    twitter: "https://twitter.com/arjun_roy",
  },
...
const orgBlueprints = [
  {
    ...
    users: [
      {
        name: "Aarav Mehta",
        email: "aarav.mehta@workping.live",
        phone: "8100000001",
        employeeId: "WPHQ-001",
        gender: "male",
        role: "manager",
      ...
      {
        name: "Neha Sharma",
        email: "neha.sharma@workping.live",
        phone: "8100000002",
        employeeId: "WPHQ-002",
        gender: "female",
        role: "teamLead",
      ...
      {
        name: "Imran Khan",
        email: "imran.khan@workping.live",
        phone: "8100000003",
        employeeId: "WPHQ-003",
        gender: "male",
        role: "employee",
      ...
      {
        name: "Meera Iyer",
        email: "meera.iyer@workping.live",
        phone: "8100000004",
        employeeId: "WPHQ-004",
        gender: "female",
        role: "employee",
    ...
    leaves: [
      ...
      },
      {
        userIndex: 1,
        leaveType: "Earned",
        dates: [new Date("2026-03-24"), new Date("2026-03-25")],
        status: "approved",
        approvedByIndex: 0,
    ...
    complaints: [
      {
        userIndex: 2,
        ticketId: "TKT-HQ-001",
        description: "Attendance not syncing with the mobile app for the past 3 days.",
        status: "open",
      },
      {
        userIndex: 3,
        ticketId: "TKT-HQ-002",
        description: "Leave balance showing incorrect count after manager approval.",
        status: "resolved",
        resolvedByIndex: 0,
      },
    ],
    frsTickets: [
      {
        userIndex: 3,
        ticketId: "FRS-HQ-001",
        description: "Biometric device not registering checkout punches at Mumbai HQ.",
        status: "in_progress",
      },
    ],
    clOdEntries: [
  ...
  },
  {
    ...
    users: [
      {
        name: "Riya Patel",
        email: "riya.patel@workping.live",
        phone: "8100000005",
        employeeId: "WPLB-001",
        gender: "female",
        role: "manager",
      ...
      {
        name: "Kabir Anand",
        email: "kabir.anand@workping.live",
        phone: "8100000006",
        employeeId: "WPLB-002",
        gender: "male",
        role: "teamLead",
      ...
      {
        name: "Sanya Bose",
        email: "sanya.bose@workping.live",
        phone: "8100000007",
        employeeId: "WPLB-003",
        gender: "female",
        role: "employee",
    ...
    leaves: [
      {
        userIndex: 2,
        leaveType: "Casual",
        dates: [new Date("2026-04-22"), new Date("2026-04-23")],
        status: "approved",
        approvedByIndex: 0,
    ...
    complaints: [
      {
        userIndex: 2,
        ticketId: "TKT-LB-001",
        description: "Shift timing not reflecting updated flex schedule in the portal.",
        status: "in_review",
      },
      {
        userIndex: 3,
        ticketId: "TKT-LB-002",
        description: "Overtime calculation missing for last sprint delivery week.",
        status: "resolved",
        resolvedByIndex: 1,
      },
    ],
    frsTickets: [
      {
        userIndex: 2,
        ticketId: "FRS-LB-001",
        description: "FRS device offline — attendance not captured for 2 days.",
        status: "open",
      },
    ],
    clOdEntries: [
  ...
  },
  {
    ...
    users: [
      {
        name: "Priya Nair",
        email: "priya.nair@workping.live",
        phone: "8100000009",
        employeeId: "WPCR-001",
        gender: "female",
        role: "manager",
      ...
      {
        name: "Dev Malhotra",
        email: "dev.malhotra@workping.live",
        phone: "8100000010",
        employeeId: "WPCR-002",
        gender: "male",
        role: "teamLead",
      ...
      {
        name: "Ananya Das",
        email: "ananya.das@workping.live",
        phone: "8100000011",
        employeeId: "WPCR-003",
        gender: "female",
        role: "employee",
      ...
      {
        name: "Kunal Verma",
        email: "kunal.verma@workping.live",
        phone: "8100000012",
        employeeId: "WPCR-004",
        gender: "male",
        role: "employee",
    ...
    leaves: [
      {
        userIndex: 2,
        leaveType: "Casual",
        dates: [new Date("2026-04-24"), new Date("2026-04-25")],
        status: "approved",
        approvedByIndex: 0,
        reason: "Family visit",
      },
      ...
      },
      {
        userIndex: 1,
        leaveType: "Earned",
        dates: [new Date("2026-03-27"), new Date("2026-03-28")],
        status: "approved",
        approvedByIndex: 0,
    ...
    complaints: [
      {
        userIndex: 2,
        ticketId: "TKT-CR-001",
        description: "Attendance portal login failing intermittently on mobile browser.",
        status: "open",
      },
      {
        userIndex: 3,
        ticketId: "TKT-CR-002",
        description: "SLA report export generating empty files since last update.",
        status: "resolved",
        resolvedByIndex: 0,
      },
    ],
    frsTickets: [
      {
        userIndex: 3,
        ticketId: "FRS-CR-001",
        description: "Face recognition failing due to lighting issue at workstation.",
        status: "open",
      },
    ],
    clOdEntries: [
      ...
      },
      {
        ...
        type: "OD",
        reason: "Client visit to Chennai office",
        status: "pending",
      },
    ],
  },
...
const allDemoEmails = [ADMIN_EMAIL, ...orgBlueprints.flatMap((org) => org.users.map((u) => u.email))];
...
async function cleanupDemoData() {
  ...
  const existingUserIds = await User.find({
    $or: [{ email: { $in: allUserEmails } }, { employeeId: { $in: ALL_DEMO_EMPLOYEE_IDS } }],
  }).distinct("_id");
    ...
    Account.deleteMany({
      email: {
        $in: [
          ...allDemoEmails,
          "admin@workping.com",
          "aarav.mehta@workping.com",
          "neha.sharma@workping.com",
          "imran.khan@workping.com",
          "meera.iyer@workping.com",
          "riya.patel@workping.com",
          "kabir.anand@workping.com",
          "sanya.bose@workping.com",
          "arjun.roy@workping.com",
          "priya.nair@workping.com",
          "dev.malhotra@workping.com",
          "ananya.das@workping.com",
          "kunal.verma@workping.com",
        ],
      },
    }),
  ...
  for (const blueprint of orgBlueprints) {
    ...
    for (const ub of blueprint.users) {
      ...
      const user = await User.create({
        ...
        dob: ub.dob,
        address: ub.address,
        dateOfJoining: ub.dateOfJoining,
        role: ub.role,
        isActive: true,
        workType: ub.workType,
      });
      users.push(user);
    ...
    for (const pb of blueprint.projects) {
      ...
      const project = await Project.create({
        ...
        assignedDate: pb.assignedDate,
        dueDate: pb.dueDate,
        contractedBy: pb.contractedBy,
        status: pb.status,
        shiftId: shift._id,
      });
    ...
    for (const [ui, user] of users.entries()) {
      ...
      for (const [di, date] of APRIL_WORKING_DAYS.entries()) {
        ...
        const attendanceDoc = {
          ...
          date,
          status,
          remarks: "April attendance record",
        };
        if (checkIn) {
    ...
    for (const user of users) {
      for (const mc of SALARY_MONTHS) {
        ...
        await Salary.create({
          ...
          role: user.role,
          month: mc.month,
          daysPresent: mc.daysPresent,
          lopDays: mc.lopDays,
          overtimeHours: mc.overtimeHours,
          ...
          netSalary,
          status: mc.status,
          generatedDate: new Date(`${mc.month}-28`),
        });
      }
    }
